    ...
    var u, h = /^(http(s)?):\/\//,
        ...
        b = (u = [], {
            ...
            removeEventListener: function(e, t, r, i) {
                e.removeEventListener(t, r, i), u = u.filter((function(n) {
                    return function(e, t) {
                        var r = l(e, 4),
                            i = r[0],
                            n = r[1],
                            ...
                            h = s[2],
                            f = s[3];
                        return c !== i || u !== n || h !== o || !0 === ("object" == typeof a && a ? a.capture : a) != (!0 === ("object" == typeof f && f ? f.capture : f))
                    }([e, t, r, i], n)
                }))
            }
        }),
        ...
        w = function(n) {
            function a() {
                var e;
                return (e = p.call(this)).uniqueId = null, e.initialRenderedHeightSet = !1, e.frame = e.createIframeElement(), e.attachShadowDom(), e
            }! function(e, r) {
            ...
            var s, c, l, u, h, p = (s = a, c = i(), function() {
                var e, t = r(s);
                if (c) {
            ...
            return l = a, h = [{
                ...
                value: function() {
                    var e = this.customerEmail ? encodeURIComponent(this.customerEmail) : void 0,
                        ...
                        r = "";
                    r = "".concat(y, "pricing-table-app.html?").concat(t), this.frame.src = r
                }
            }, {
                ...
                value: function() {
                    v(window, "pageshow", this.pageShowListener), v(this.frame, "load", this.reInitializeIframe, !1)
                }
            }, {
                ...
                key: "messageIframe",
                value: function(e) {
                    var t, r = (t = f(y)) ? t.origin : null;
                    if (!r) throw Error("stripe-pricing-table: target origin is null");
                    this.frame.contentWindow && this.frame.contentWindow.postMessage(e, r)
                }
            }, {
                key: "reloadIframe",
                value: function() {
            ...
            }]) && e(l.prototype, u), h && e(l, h), Object.defineProperty(l, "prototype", {
                writable: !1
            }), a
        }(s(HTMLElement));
    void 0 === customElements.get("stripe-pricing-table") && customElements.define("stripe-pricing-table", w)
}();
